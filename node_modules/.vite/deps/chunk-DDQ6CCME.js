  ...
  "node_modules/@babylonjs/core/Maths/math.vector.js"() {
    ...
    Vector3 = function() {
      ...
      Vector32.prototype.projectOnPlaneToRef = function(plane, origin, result) {
        ...
        var dotProduct = Vector32.Dot(inverseNormal, this);
        ...
        var hitDistance = Vector32.Dot(relativeOrigin, inverseNormal) / dotProduct;
    ...
    Quaternion = function() {
      ...
      Quaternion2.prototype.toArray = function(array, index) {
        if (index === void 0) {
          index = 0;
        }
        array[index] = this.x;
...
var init_tools = __esm({
  "node_modules/@babylonjs/core/Misc/tools.js"() {
    ...
    Tools = function() {
      ...
      Tools2.SetReferrerPolicyBehavior = function(referrerPolicy, element) {
      ...
      Tools2.DownloadBlob = function(blob, fileName) {
      ...
      Tools2.EncodeScreenshotCanvasData = function(successCallback, mimeType, fileName, canvas, quality) {
        ...
        if (successCallback) {
          ...
          this.ToBlob(canvas !== null && canvas !== void 0 ? canvas : Tools2._ScreenshotCanvas, function(blob) {
            if (blob) {
              Tools2.DownloadBlob(blob, fileName);
            }
          }, mimeType, quality);
        }
      };
...
var init_buffer = __esm({
  "node_modules/@babylonjs/core/Buffers/buffer.js"() {
    init_dataBuffer();
    Buffer = function() {
      function Buffer2(engine, data, updatable, stride, postponeInternalCreation, instanced, useBytes, divisor) {
        if (stride === void 0) {
          stride = 0;
        }
      ...
      Buffer2.prototype.createVertexBuffer = function(kind, offset, size, stride, instanced, useBytes, divisor) {
        if (useBytes === void 0) {
          useBytes = false;
        }
      ...
      Buffer2.prototype.isUpdatable = function() {
        return this._updatable;
      };
      Buffer2.prototype.getData = function() {
        return this._data;
      };
      Buffer2.prototype.getBuffer = function() {
        return this._buffer;
      };
      Buffer2.prototype.getStrideSize = function() {
        return this.byteStride / Float32Array.BYTES_PER_ELEMENT;
      };
      Buffer2.prototype.create = function(data) {
        if (data === void 0) {
          data = null;
        }
      ...
      Buffer2.prototype._rebuild = function() {
        this._buffer = null;
      ...
      Buffer2.prototype.updateDirectly = function(data, offset, vertexCount, useBytes) {
        if (useBytes === void 0) {
          useBytes = false;
        }
        if (!this._buffer) {
      ...
      Buffer2.prototype._increaseReferences = function() {
        if (!this._buffer) {
          return;
        }
...
var init_sceneComponent = __esm({
  "node_modules/@babylonjs/core/sceneComponent.js"() {
    ...
    SceneComponentConstants = function() {
      ...
      SceneComponentConstants2.STEP_BEFORECLEAR_PREPASS = 1;
      SceneComponentConstants2.STEP_BEFORERENDERTARGETCLEAR_PREPASS = 0;
...
//# sourceMappingURL=chunk-DDQ6CCME.js.map
